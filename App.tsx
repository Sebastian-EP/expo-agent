    ...
    <div className="App">
      <div className="stats">
        ...
        <div className="credits">
          <img src="./assets/github.png" onClick={() => window.location.href = "https://github.com/cp-daniel-mccoy/burn-calc"} />
          <img src="./assets/outpost-built.png" onClick={() => window.location.href = "https://twitter.com/EnterOutpost"} />
        </div>
      </div>
    </div>
  )
